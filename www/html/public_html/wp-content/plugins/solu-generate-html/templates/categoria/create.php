    ...
    <form method="post" id="codeForm" action="">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" name="name_group" id="name_group" value="" class="regular-text" required="required" placeholder="Ej: category_electronica, brand_nike, etc.">
                    <p class="description">
            ...
            <tr>
                ...
                <td>
                    <textarea name="code" id="code" rows="20" cols="80" class="large-text code" placeholder="Ingresa aquí tu código HTML..." style=""></textarea>
                    <p class="description">Puedes incluir código PHP y HTML. Usa variables como $category, $brand, etc. según el contexto.</p>
                </td>
            </tr>
        </table>
        <input type="hidden" name="action" value="create">
        <?php submit_button('Crear Código HTML'); ?>
    </form>
</div>
