...
/**
 * Solu_Generate_HTML_DateUtils - Clase utilitaria para manejo de fechas
 * 
 * Esta clase proporciona métodos para el manejo, formateo, validación y manipulación
 * de fechas en el plugin Solu Generate HTML. Incluye soporte para diferentes zonas
 ...
 * 
 * @example
 * // Crear instancia con zona horaria por defecto (America/Lima)
 * $dateUtils = new Solu_Generate_HTML_DateUtils();
 * 
 ...
 * 
 * // América del Norte
 * $dateUtilsNY = new Solu_Generate_HTML_DateUtils('America/New_York');        // Nueva York (EST/EDT)
 * $dateUtilsLA = new Solu_Generate_HTML_DateUtils('America/Los_Angeles');     // Los Ángeles (PST/PDT)
 * $dateUtilsChicago = new Solu_Generate_HTML_DateUtils('America/Chicago');    // Chicago (CST/CDT)
 * $dateUtilsDenver = new Solu_Generate_HTML_DateUtils('America/Denver');      // Denver (MST/MDT)
 * $dateUtilsToronto = new Solu_Generate_HTML_DateUtils('America/Toronto');    // Toronto (EST/EDT)
 * $dateUtilsVancouver = new Solu_Generate_HTML_DateUtils('America/Vancouver'); // Vancouver (PST/PDT)
 * 
 * // América del Sur
...
class Solu_Generate_HTML_DateUtils
{
    /**
